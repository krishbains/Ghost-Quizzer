        ...
        >
          <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 shadow-2xl mx-4">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-white/80 max-w-2xl mx-auto leading-relaxed px-2">
              Enter your details and join the ultimate quiz experience
            </p>
          </div>
        </motion.header>
            ...
            <div className="relative z-10 space-y-6 sm:space-y-8">
              ...
              <div className="space-y-2 sm:space-y-3">
                ...
                <div className="relative">
                  <input
                    ...
                    onKeyPress={handleKeyPress}
                    className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white/10 border border-white/20 rounded-xl sm:rounded-2xl text-white placeholder-white/50 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-400/50 transition-all duration-300 text-base sm:text-lg tracking-wider"
                  />
                  <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-r from-blue-500/10 to-cyan-500/10 opacity-0 focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"></div>
                </div>
              </div>
              ...
              <div className="text-center pt-4 sm:pt-6">
                <p className="text-white/60 text-xs sm:text-sm">
                  💡 Pro tip: Make sure you have the correct room code from your host!
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-2xl px-6 sm:px-8 py-4">
            <div className="text-white/60 text-sm sm:text-base">
              Ready to test your knowledge? Join the quiz and compete with friends!
            </div>
          </div>
        </motion.footer>
      </div>
