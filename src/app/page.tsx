  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 font-sans overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Floating orbs with enhanced animations - reduced size for mobile */}
        <div className="absolute top-1/4 left-1/4 w-48 h-48 sm:w-72 sm:h-72 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-full blur-3xl animate-pulse-glow animate-float"></div>
        <div className="absolute top-3/4 right-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-full blur-3xl animate-pulse-glow animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] sm:w-[800px] sm:h-[800px] bg-gradient-to-r from-indigo-500/10 to-purple-500/10 rounded-full blur-3xl animate-pulse-glow animate-float" style={{ animationDelay: '4s' }}></div>
        ...
        {/* Mouse-following glow (optimized) - hidden on mobile */}
        <div
          ref={glowRef}
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 sm:px-6 lg:px-12 py-8 sm:py-16">
        ...
        <div className="w-full max-w-5xl mb-12 sm:mb-20 px-4">
          <div className="backdrop-blur-3xl bg-white/10 border border-white/20 rounded-2xl sm:rounded-3xl shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden p-6 sm:p-8 lg:p-12 relative group animate-glow">
            {/* Animated border */}
            <div className="absolute inset-0 rounded-2xl sm:rounded-3xl bg-gradient-to-r from-purple-500/20 via-pink-500/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 animate-border-flow"></div>
            ...
            <div className="relative z-10">
              <div className="text-center mb-4 sm:mb-6">
                <h3 className="text-xl sm:text-2xl font-bold text-white/90 mb-2">Level up your 🧠</h3>
                <p className="text-white/60 text-sm sm:text-base">Poll topics with your peers and watch them come to life with AI.</p>
              </div>
        ...
        {/* DIVIDER WITH GLOW */}
        <div className="relative w-full max-w-4xl mb-12 sm:mb-16 px-4">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 mb-12 sm:mb-16 px-4 w-full">
          <button className="group relative w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-2xl border border-white/20 rounded-2xl hover:scale-105 active:scale-100 transition-all duration-500 font-bold text-base sm:text-lg text-white shadow-2xl overflow-hidden animate-glow"
          ...
          <button
            className="group relative w-full sm:w-auto px-8 sm:px-10 py-4 sm:py-5 bg-gradient-to-r from-blue-500/20 to-blue-600/20 backdrop-blur-2xl border border-blue-400/30 rounded-2xl hover:scale-105 active:scale-100 transition-all duration-500 font-bold text-base sm:text-lg text-white shadow-2xl overflow-hidden animate-glow"
        ...
        <div className="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-2xl px-6 sm:px-8 py-4 mb-12 sm:mb-16 animate-glow mx-4" style={{ animationDelay: '1.5s' }}>
          <div className="text-white/70 text-center text-sm sm:text-base">
            <span className="font-semibold text-white">Trusted by thousands of quiz masters</span> worldwide
          </div>
        </div>

        {/* Footer */}
        <footer className="text-white/40 text-xs sm:text-sm px-4">
